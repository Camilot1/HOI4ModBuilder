...
- [5] Рабочий слой - определяет текущий редактируемый слой карты в программе
    ...
    Каждый инструмент содержит свой набор слоёв, на которых он может работать и вносить изменения (см. подробнее в: [Инструменты для работы с картой](/doc/tools/map/lang=ru.md))
    </details>
---
- [6] Инструмент - определяет активный инструмент для редактирования карты
    ...
    Подробное описание и инструкция по работе с каждым инструментом приведены в статье: [Инструменты для работы с картой](/doc/tools/map/lang=ru.md)
    
    Поддерживает использование следующих инструментов:
    - Курсор **[C]** - позволяет взаимодействовать и выбирать объекты на карте  (см. подробнее в [Инструмент "Курсор"](/doc/tools/map/common/cursor/lang=ru.md))
    ...
    - Кисть **[B]** - позволяет рисовать на картах (см. подробнее в [Инструмент "Кисть"](/doc/tools/map/common/brush/lang=ru.md))
  
    - Заливка **[F]** - позволяет заливать зоны на картах выбранным цветом (см. подробнее в [Инструмент "Заливка"](/doc/tools/map/common/fill/lang=ru.md))
  
    - Ластик **[E]** - позволяет стирать на картах пиксели (или в некоторых случаях заливать их белым цветом) (см. подробнее в [Инструмент "Ластик"](/doc/tools/map/common/eraser/lang=ru.md))
  
    - Пипетка **[K]** - позволяет выбирать (копировать) цвет пикселей на карте (см. подробнее в [Инструмент "Пипетка"](/doc/tools/map/common/pipette/lang=ru.md))
  
    - Тип провинции - позволяет менять тип провинции (land, lake, sea) (см. подробнее в [Инструмент "Тип провинции"](/doc/tools/map/common/province_type/lang=ru.md))
  
    - Прибрежность - позволяет редактировать тип пребрежности провинций на карте (см. подробнее в [Инструмент "Прибрежность"](/doc/tools/map/common/province_coastal/lang=ru.md))
  
    - Местность **[SHIFT+T]** - позволяет редактировать местность провинций на карте (см. подробнее в [Инструмент "Местность"](/doc/tools/map/common/terrain/lang=ru.md))
  
    - Континент **[SHIFT+C]** - позволяет редактировать континент провинций на карте (см. подробнее в [Инструмент "Континент"](/doc/tools/map/common/province_continent/lang=ru.md))
  
    - Область **[SHIFT+S]** - позволяет редактировать принадлежность провинций к областям (states) на карте. При передаче провинции между областями в новый State передаются также её постройки, очки победы и другие данные (см. подробнее в [Инструмент "Область"](/doc/tools/map/common/province_state/lang=ru.md))
  
    - Регион **[SHIFT+R]** - позволяет редактировать регион (Strategic Region) провинций на карте (см. подробнее в [Инструмент "Регион"](/doc/tools/map/common/province_region/lang=ru.md))
  
    - Категория области - позволяет редактировать категорию области (state_category) у целевой области (State) на карте (см. подробнее в [Инструмент "Категория области"](/doc/tools/map/common/state_category/lang=ru.md))
  
    - Владелец области - позволяет редактировать страну-владельца (owner) у целевой области (State) на карте (см. подробнее в [Инструмент "Владелец области"](/doc/tools/map/common/state_owner/lang=ru.md))
  
    - Контроль области - позволяет редактировать страну, контролирующую (controller) целевую область (State) на карте (см. подробнее в [Инструмент "Контроль области"](/doc/tools/map/common/state_controller/lang=ru.md))
  
    - Национальная область - позволяет редактировать список национальных областей выбранной страны (см. подробнее в [Инструмент "Претензия на область"](/doc/tools/map/common/state_core_of/lang=ru.md))

    - Претензия на область - позволяет редактировать список претензий выбранной страны на области на карте (см. подробнее в [Инструмент "Претензия на область"](/doc/tools/map/common/state_claim_by/lang=ru.md))
  
    - Постройки **[SHIFT+B]** - позволяет редактировать уровень построек в целовой провинции или целевой области (State) на карте (зависит от типа выбранной постройки) (см. подробнее в [Инструмент "Постройки"](/doc/tools/map/common/buildings/lang=ru.md))
  
    - Очки победы **[SHIFT+V]** - позволяет редактировать количество очков победы в целевой провинции на карте (см. подробнее в [Инструмент "Очки победы"](/doc/tools/map/common/victory_points/lang=ru.md))

    - Зоны ИИ **[SHIFT+A]** - позволяет редактировать вхождение континентов или стратегических регионов в зоны ИИ (ai_areas) (см. подробнее в [Инструмент "Зоны ИИ"](/doc/tools/map/common/ai_area/lang=ru.md))
  
    - Ресурсы **[B]** - позволяет редактировать количество выбранного ресурса в указанной области на карте (см. подробнее в [Инструмент "Ресурсы"](/doc/tools/map/common/resources/lang=ru.md))
...
- [13] Дополнительные слои - текстурные карты или объекты, накладываемые поверх основного слоя карты.
  ...
  ![alt text](_images/leftbar_additional_layers_lang=ru.jpg)
    ...
    - Железные дороги - включает отображение железных дорог поверх основного слоя (о создании, редактировании и удалении см. подробнее в: [Инструменты для работы с картой](/doc/tools/map/lang=ru.md)) 
    ![alt text](_images/leftbar_additional_layers_railways_lang=ru.jpg)
    - Узлы снабжения - включает отображение узлов снабжения поверх основного слоя (о создании, редактировании и удалении см. подробнее в: [Инструменты для работы с картой](/doc/tools/map/lang=ru.md))
    ![alt text](_images/leftbar_additional_layers_supply_hubs_lang=ru.jpg)
    - Смежности - включает отображение смежностей между провинциями из файла adjacencies.csv (о создании, редактировании и удалении см. подробнее в: [Инструменты для работы с картой](/doc/tools/map/lang=ru.md))
    ![alt text](_images/leftbar_additional_layers_adjacencies_lang=ru.jpg)
    - Непроходимые зоны - временно отключено и не работает
    - Предупреждения - включает отображение связанных с картой предупреждений, которые не являются критичными, но на них следует обратить внимание (см. подробнее в: [Поиск предупреждений и ошибок на карте](/doc/warnings_and_errors_search/lang=ru.md))
    ![alt text](_images/leftbar_additional_layers_warnings_lang=ru.jpg)
    - Ошибки - включает отображение важных и/или критических связанных с игровой картой ошибок, которые в том числе могут приводить к крашу игры (см. подробнее в: [Поиск предупреждений и ошибок на карте](/doc/warnings_and_errors_search/lang=ru.md))
...
---
- [15] Настройки поиска предупреждений - позволяет выбрать список предупреждений, связанных с картой, которые программе необходимо найти и вывести при загрузке или обновлении данных мода (см. подробнее в: [Поиск предупреждений и ошибок на карте](/doc/warnings_and_errors_search/lang=ru.md))
...
---
- [16] Настройки поиска ошибок - позволяет выбрать список важных и критических ошибок, связанных с картой, которые программе необходимо найти и вывести при загрузке или обновлении данных мода (см. подробнее в: [Поиск предупреждений и ошибок на карте](/doc/warnings_and_errors_search/lang=ru.md))
