...
Пункт меню "Провинция" - выводит краткую информацию о провинции и даёт ещё один способ (помимо соответствующих инструментов, см. подробнее [Инструменты для работы с картой](/doc/tools/map/lang=ru.md)) для редактирования таких параметров провинции, как:
...
Пункт меню "Смежность" - позволяет создавать, редактировать и удалять смежности (adjacencies) между провинциями (см. подробнее [Инструмент "Смежности"](/doc/tools/map/advanced/supply_hubs/lang=ru.md)).
...
Пункт меню "Железная дорога" - позволяет создавать, редактировать, разделять, соединять и удалять железные дороги (см. подробнее [Инструмент "Железные дороги"](/doc/tools/map/advanced/railways/lang=ru.md)). 
...
Пункт меню "Узел снабжения" - позволяет создавать и удалять узлы снабжения на карте (см. подробнее [Инструмент "Железные дороги"](/doc/tools/map/advanced/supply_hubs/lang=ru.md)). 
...
1. Объединить с заменой - объединяет две выбранные провинции (см. подробнее [Инструмент "Объединение провинций"](/doc/tools/map/advanced/merge_provinces/lang=ru.md));
2. Объединить все с заменой - объединяет все выбранные провинции в группе (см. подробнее [Инструмент "Объединение провинций"](/doc/tools/map/advanced/merge_provinces/lang=ru.md)). 
