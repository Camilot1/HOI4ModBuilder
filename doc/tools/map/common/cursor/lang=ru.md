...
1. Железные дороги (см. подробнее в статье: [Инструмент "Железные дороги"](/doc/tools/map/advanced/railways/lang=ru.md))
2. Узлы снабжения (см. подробнее в статье: [Инструмент "Узлы снабжения"](/doc/tools/map/advanced/supply_hubs/lang=ru.md))
3. Смежности (см. подробнее в статье: [Инструмент "Узлы снабжения"](/doc/tools/map/advanced/supply_hubs/lang=ru.md))
...
Более подробно взаимодействие с объектами описано в статьях выше, а также в статье [Контекстное меню](/doc/interfaces/map/context_menu/lang=ru.md).
