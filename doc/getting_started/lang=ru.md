...
#### Подробнее о других пунктах настроек можно узнать в статье: [Окно настроек](/doc/interfaces/settings/lang=ru.md)
...
### 1. Статья: [Интерфейс карты](/doc/interfaces/map/lang=ru.md)
### 2. Статья: [Навигация по карте](/doc/interfaces/map/navigation/lang=ru.md)
