...
{
    public class NextIntMethod : ScriptCommand
    {
        private static readonly string _keyword = "NEXT_INT";
        ...
        public override ScriptCommand CreateEmptyCopy() => new NextIntMethod();
        ...
        public override void Parse(string[] lines, ref int index, int indent, VarsScope varsScope, string[] args)
        {
            ...
            _action = delegate ()
            {
                ...
                if (args.Length == 4)
                {
                    ...
                    randomObj.NextInt(lineIndex, args, maxValue, resultValue);
                }
                else if (args.Length == 5)
                {
                    ...
                    randomObj.NextInt(lineIndex, args, minValue, maxValue, resultValue);
                }
