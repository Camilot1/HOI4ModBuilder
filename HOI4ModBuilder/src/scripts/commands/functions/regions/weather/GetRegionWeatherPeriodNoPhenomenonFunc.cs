...
{
    public class GetRegionWeatherPeriodNoPhenomenonFunc : ScriptCommand
    {
        ...
        public override ScriptCommand CreateEmptyCopy() => new GetRegionWeatherPeriodNoPhenomenonFunc();
        ...
        public override void Parse(string[] lines, ref int index, int indent, VarsScope varsScope, string[] args)
        {
            ...
            _action = delegate ()
            {
                ...
                int argIndexWeatherRegionIndex = 3;
                var weatherPeriodIndex = ScriptParser.ParseValue(
                    varsScope, args[argIndexWeatherRegionIndex], lineIndex, args,
                    (o) => o is INumberObject
                );
                ...
                if (!region.TryGetWeatherPeriod(Convert.ToInt32(weatherPeriodIndex.GetValue()), out var period))
                    throw new IndexOutOfRangeScriptException(lineIndex, args, weatherPeriodIndex.GetValue(), argIndexWeatherRegionIndex);
