...
{
    public class GetRegionWeatherPeriodRainLightFunction : ScriptCommand
    {
        ...
        public override ScriptCommand CreateEmptyCopy() => new GetRegionWeatherPeriodRainLightFunction();
