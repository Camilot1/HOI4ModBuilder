...
{
    public class GetStateControllerFunc : ScriptCommand
    {
        private static readonly string _keyword = "GET_STATE_CONTROLLER";
        ...
        public override ScriptCommand CreateEmptyCopy() => new GetStateControllerFunc();
        ...
        public override void Parse(string[] lines, ref int index, int indent, VarsScope varsScope, string[] args)
        {
            ...
            _action = delegate ()
            {
                ...
                countryTag.Set(lineIndex, args, new StringObject(state.controller?.Tag));
            };
        }
    }
}
