...
{
    public class FloatObject : IScriptObject, INumberObject, IPrimitiveObject
    {
        ...
        public bool IsSameType(IScriptObject scriptObject) => scriptObject is FloatObject;
        public IScriptObject GetEmptyCopy() => new FloatObject();
        public IScriptObject GetCopy() => new FloatObject(Value);
        public string GetKeyword() => FloatDeclarator.GetKeyword();
        public override string ToString() => GetKeyword() + "(" + Value + ")";
        public override bool Equals(object obj)
            => obj is FloatObject @object &&
                   Value == @object.Value;
