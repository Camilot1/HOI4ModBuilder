...
{
    public class CharObject : INumberObject, IPrimitiveObject
    {
        public char Value { get; set; }
        public object GetValue() => Value;

        public CharObject() { }
        public CharObject(char value) { Value = value; }

        public bool IsSameType(IScriptObject scriptObject) => scriptObject is CharObject;
        public IScriptObject GetEmptyCopy() => new CharObject();
        public IScriptObject GetCopy() => new CharObject(Value);
        public string GetKeyword() => CharDeclarator.GetKeyword();
        public override string ToString() => GetKeyword() + "(" + Value + ")";
        public override bool Equals(object obj)
            => obj is CharObject @object &&
                   Value == @object.Value;
