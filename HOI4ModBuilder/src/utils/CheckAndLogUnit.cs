...
namespace HOI4ModBuilder.src.utils
{
    class CheckAndLogUnit
    {
        ...
        private Action<LinkedLayer, EnumLocKey, Dictionary<string, string>> _action0;
        private Action<LinkedLayer, string, EnumLocKey, Dictionary<string, string>> _action1;

        public CheckAndLogUnit(
            Action<LinkedLayer, EnumLocKey, Dictionary<string, string>> action0,
            Action<LinkedLayer, string, EnumLocKey, Dictionary<string, string>> action1
        )
        {
            _action0 = action0;
            _action1 = action1;
        ...
        public CheckAndLogUnit HasAtLeastOneMandatory(ref bool result, LinkedLayer prevLayer, string currentLayer, string[] parametersNames, bool hasAtLeastOneValue)
        {
            ...
            {
                _action1(
                    prevLayer, currentLayer, EnumLocKey.BLOCK_MUST_HAS_AT_LEAST_ONE_MANDATORY_PARAMETER,
