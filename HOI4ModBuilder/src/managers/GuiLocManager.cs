...
namespace HOI4ModBuilder.src.utils
{
    ...
    public enum EnumLocKey
    {
        ...
        SINGLE_MESSAGE_STATE_NOT_FOUND_BY_ID,
        ...
        EXCEPTION_UNKNOWN_TOKEN,
        WARNING_LAYERED_LEVELS_PARAMETER_VALUE_OVERRIDDEN_IN_FILE,
        WARNING_LAYERED_LEVELS_BLOCK_VALUE_OVERRIDDEN_IN_FILE,
        EXCEPTION_COUNTRY_NOT_FOUND,
        EXCEPTION_INCORRECT_VALUE,
        EXCEPTION_DIVISION_NAMES_GROUP_NOT_FOUND,
        WARNING_BLOCK_HAS_NO_MANDATORY_INNER_PARAMETER_IN_FILE,
    }
}
