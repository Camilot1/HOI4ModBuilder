...
namespace HOI4ModBuilder.src.utils
{
    ...
    public enum EnumLocKey
    {
        ...
        SINGLE_MESSAGE_NO_REQUIRED_FOLDER_IN_DIRECTORY_IN_DOCUMENTS,
        ...
        EXCEPTION_LOADING_BULDINGS_CUSTOM_ARGS_BLOCKS_BUILDING_WASNT_LOADED,
        EXCEPTION_FILE_ALREADY_EXISTS,
        ACTION_WAS_CANCELED,
        WARNINGS_ACTION_WILL_AFFECT_MORE_THAN_X_PIXELS,
        UNABLE_TO_GENERATE_COLOR_WITHIN_PROVIDED_CONSTRAINTS,
        AUTOTOOL_REGENERATE_PROVINCES_COLORS_PROVINCES,
        AUTOTOOL_REGENERATE_PROVINCES_COLORS_STATES,
        AUTOTOOL_REGENERATE_PROVINCES_COLORS_REGIONS,
        AUTOTOOL_REGENERATE_PROVINCES_COLORS_COMPLETED,
        COLOR_GENERATION_PATTERN_HSV_RANGES_DIFFERENCE,
        COLOR_GENERATION_PATTERN_HSV_RANGES_HUE,
        COLOR_GENERATION_PATTERN_HSV_RANGES_SATURATION,
        COLOR_GENERATION_PATTERN_HSV_RANGES_VALUE,
        PROVINCE_TYPE,
        STATE_CATEGORY,
        TERRAINS,
        PROVINCES_BORDERS,
        ...
        MAP_TAB_PROGRESSBAR_MAP_WARNINGS_AND_ERRORS_SEARCHING,
        WARNING_TOO_MUCH_PROVINCE_BORDERS,
        WARNING_STATE_HAS_BUILDINGS_FOR_NON_LAND_PROVINCES_AND_THEY_WILL_BE_REMOVED,
        WARNING_PROVINCES_MAP_TOO_MUCH_PIXELS,
        WARNING_PROVINCES_MAP_WIDTH_IS_NOT_MULTIPLE_OF_256,
        WARNING_PROVINCES_MAP_HEIGHT_IS_NOT_MULTIPLE_OF_256,
        WARNING_RAILWAY_NOT_VALID_PROVINCES_WILL_BE_REMOVED,
        WARNING_RAILWAY_HAS_NOT_ENOUGH_VALID_PROVINCES_AND_WILL_BE_REMOVED,
        WARNING_SUPPLY_HUB_IS_NOT_VALID_PROVINCES_AND_WILL_BE_REMOVED,
        ERROR_WHILE_STATE_CATEGORY_LOADING,
        EXCEPTION_MORE_THAN_ONE_STATE_CATEGORY_IN_FILE,
        WARNING_STATE_FORCE_LINK_OWNERSHIP_POINTS_TO_NOT_PRESENT_STATE,
        MAP_TAB_PROGRESSBAR_LOADING_STRATEGIC_LOCATIONS,
        ERROR_WHILE_STRATEGIC_LOCATIONS_LOADING,
        WARNING_STATE_CATEGORY_INVALID_COLOR,
        EXCEPTION_NETWORK_UNABLE_TO_CHECK_FOR_UPDATE,
        DESKTOP_SHORCUT_CREATED,
        EXCEPTION_PARSED_OBJECT_NOT_FOUND,
        EXCEPTION_PARSED_OBJECT_INVALID_VALUE,
        MAP_TAB_PROGRESSBAR_BORDERS_TEXTURES_ASSEMBLE,
        EXCEPTION_ACTION_EXECUTION_FAILED,
        ERROR_MAP_FAILED_TO_LOAD_MAP_FILE,
        MAP_TAB_PROGRESSBAR_PROCESS_PROVINCES_PIXELS,
    }
}
